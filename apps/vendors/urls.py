...
urlpatterns = [
    ...
    path('dashboard/reviews/', views.store_reviews, name='store_reviews'),
    path('dashboard/policy/', views.store_policy, name='store_policy'),
    path('dashboard/products/image/<int:pk>/delete/', views.delete_product_image, name='delete_product_image'),
    ...
    path('superadmin/users/change-password/<int:pk>/', views.superadmin_change_password, name='superadmin_change_password'),
